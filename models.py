...
class ValorMedicion(Base):
    ...
    medicion_id = Column(
        Integer,
        ForeignKey("mediciones.id"),
        nullable=False,
    )
    tipo_medicion_id = Column(
        Integer,
        ForeignKey("tipos_medicion.id"),
        nullable=False,
    )
    valor = Column(
        Numeric(10, 3),
...
class RangoRiesgo(Base):
    ...
    nivel_riesgo_id = Column(
        Integer,
        ForeignKey("niveles_riesgo.id"),
        nullable=False,
    )
    valor_min = Column(
        Numeric(10, 3),
...
class Alerta(Base):
    ...
    id = Column(Integer, primary_key=True)
    clasificacion_id = Column(
        Integer,
        ForeignKey("clasificaciones.id"),
        nullable=False,
    )
    fecha_generada = Column(
        DateTime,
        server_default=func.now(),
        nullable=False,
    )
...
class Calibracion(Base):
    ...
    id = Column(Integer, primary_key=True)
    dispositivo_sensor_id = Column(
        Integer,
        ForeignKey("dispositivo_sensores.id"),
        nullable=False,
    )
